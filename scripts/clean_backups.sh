...
/home/pi/printer_data/config/scripts/move_files.sh /home/pi/printer_data/config/ /home/pi/printer_data/config/archive/ "/home/pi/printer_data/config/printer-\d{8}_\d{6}\.cfg"